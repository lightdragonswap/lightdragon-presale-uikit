...
var darkColors = __assign(__assign(__assign({}, baseColors), additionalColors), { secondary: "#ECD76E", background: "#10242B", backgroundDisabled: "#333A3E", 
    ...
    backgroundAlt: "#54412fcc", cardBorder: "#383241", contrast: "#FFFFFF", dropdown: "#1E1D20", dropdownDeep: "#100C18", invertedContrast: "#25210d", input: "#25210d", inputSecondary: "#262130", primaryDark: "#0098A1", tertiary: "#0F2121", text: "#EAE2FC", textDisabled: "#666171", textSubtle: "#ddd1c1", borderColor: "#524B63", gradients: {
...
var Logo$2 = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 500 500" }, props),
        React__default['default'].createElement("image", { width: "500", height: "500", href: isDark ? '/images/LogoTextNewDark.png' : '/images/LogoTextNewWhite.png' })));
};
...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, null,
        !hideSidebar && React__default['default'].createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React__default['default'].createElement(Icon$m, { width: "24px", color: "textSubtle" })) : (React__default['default'].createElement(Icon$n, { width: "24px", color: "textSubtle" }))),
...
var Menu = function (_a) {
    var _b;
    var account = _a.account, hideSidebar = _a.hideSidebar, login = _a.login, logout = _a.logout, isDark = _a.isDark, toggleTheme = _a.toggleTheme, langs = _a.langs, setLang = _a.setLang, currentLang = _a.currentLang, cakePriceUsd = _a.cakePriceUsd, links = _a.links, profile = _a.profile, children = _a.children;
    ...
    return (React__default['default'].createElement(Wrapper, null,
        ...
        React__default['default'].createElement(BodyWrapper, null,
            !hideSidebar && React__default['default'].createElement(Panel, { isPushed: isPushed, isMobile: isMobile, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, pushNav: setIsPushed, links: links }),
