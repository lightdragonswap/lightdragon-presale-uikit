...
var Logo$2 = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 500 500" }, props),
        React.createElement("image", { width: "500", height: "500", href: isDark ? '/images/LogoTextNewDark.png' : '/images/LogoTextNewWhite.png' })));
};
...
var Logo = function (_a) {
    ...
    return (React.createElement(Flex, null,
        !hideSidebar && React.createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React.createElement(Icon$m, { width: "24px", color: "textSubtle" })) : (React.createElement(Icon$n, { width: "24px", color: "textSubtle" }))),
...
var Menu = function (_a) {
    ...
    return (React.createElement(Wrapper, null,
        ...
        React.createElement(BodyWrapper, null,
            !hideSidebar && React.createElement(Panel, { isPushed: isPushed, isMobile: isMobile, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, pushNav: setIsPushed, links: links }),
